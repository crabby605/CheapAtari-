...
do
{
	...
	case '3':
		...
		for(int i=500;i>-100;i--)
		{
			...
			outtextxy(280,i+22,"Programmers and Helpers");
			line(280,i+37,366,i+37);
			outtextxy(260,i+42," Vihaan Pingalkar");
			outtextxy(260,i+54,"  AKA Crabby605");
			outtextxy(200,i+70,"This Program was Made Using Turbo C++ and Some help from StackOverflow, chatGPT , Nora and my irl teacher <3");
			outtextxy(260,i+82,"completely open source!!");
			delay(10);
			setcolor(0);
			outtextxy(300,i,"Credits");
			line(300,i+15,350,i+15);
